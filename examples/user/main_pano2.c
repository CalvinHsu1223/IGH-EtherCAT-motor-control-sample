...
//		temp[5]=EC_READ_U32(domain2_pd + digital_input);
		...
		printf("0 is ok\n");
                ...
                else if(((temp[0]&0x004f) == 0x0040) && ((temp[1]&0x004f) == 0x0040)){
                EC_WRITE_U16(domain1_pd+ctrl_word, 0x0006 );
                EC_WRITE_U16(domain1_pd+ctrl_word2, 0x0006 );
		printf("%x\n",temp[0]);
		printf("1 is ok\n");
                }
                else if(((temp[0]&0x006f) == 0x0021) && ((temp[1]&0x006f) == 0x0021)){
                EC_WRITE_U16(domain1_pd+ctrl_word, 0x0007 );
                EC_WRITE_U16(domain1_pd+ctrl_word2, 0x0007 );
      		printf("%x\n",temp[0]);
       		printf("2 is ok\n");
		}
                else if(((temp[0]&0x006f) == 0x0023) && ((temp[1]&0x006f) == 0x0023)){
		...
		printf("3 is ok\n");
                ...
                else if(((temp[0]&0x006f) == 0x0027) && ((temp[1]&0x006f) == 0x0027)){
                        EC_WRITE_S32(domain1_pd+tar_pos, (value+=1) );
                        EC_WRITE_U16(domain1_pd+ctrl_word, 0x001f);
                        EC_WRITE_S32(domain1_pd+tar_pos2, (value+=1) );
